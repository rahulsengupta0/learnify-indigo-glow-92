...
const sidebarMenuButtonVariants = (props) => {
  ...
  const variantClass = props?.variant ? variants.variant[props.variant] || "" : variants.variant.default;
  const sizeClass = props?.size ? variants.size[props.size] || variants.size.default : variants.size.default;
