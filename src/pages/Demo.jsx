  ...
  const lmsFeatures = [
    {
      ...
      description:
        'Build engaging courses with our intuitive drag-and-drop editor, multimedia support, and interactive elements.',
    },
    {
      icon: <Video className="h-8 w-8 text-purple-600" />,
      title: 'Live & Self-Paced Learning',
      description:
        'Deliver content through live sessions, recorded videos, or self-paced modules to suit different learning styles.',
    },
    {
      icon: <BarChart3 className="h-8 w-8 text-green-600" />,
      title: 'Progress Tracking & Analytics',
      description:
        'Monitor learner progress with detailed analytics, completion rates, and performance insights.',
    },
    {
      icon: <Users className="h-8 w-8 text-blue-600" />,
      title: 'User Management',
      description:
        'Efficiently manage students, instructors, and administrators with role-based access controls.',
    },
    {
      icon: <Award className="h-8 w-8 text-yellow-600" />,
      title: 'Certification Engine',
      description:
        'Create and issue digital certificates and badges upon course completion or milestone achievements.',
    },
    {
      icon: <Settings className="h-8 w-8 text-gray-600" />,
      title: 'Admin Tools',
      description:
        'Comprehensive administrative dashboard for managing courses, users, reports, and system settings.',
    },
  ];
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center max-w-4xl mx-auto animate-fade-in">
              ...
              <p className="subtext max-w-3xl mx-auto mb-10">
                See how our LMS platform empowers educators, engages learners, and delivers measurable results for institutions of all sizes.
              </p>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div>
                ...
                <p className="subtext mb-8">
                  Athena's clean, modern interface makes learning management effortless. From course creation to student analytics, everything is designed for simplicity and efficiency.
                </p>
